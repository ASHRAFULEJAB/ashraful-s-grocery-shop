        ...
        <div className="grid max-w-screen-lg gap-8 row-gap-5 md:row-gap-8 sm:mx-auto lg:grid-cols-2">
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                ...
                petticoat. Comes with red printed and embroidered voile stitched
                blouse.Comes with red printed and embroidered voile stitched
                blouse.
              </p>
              <button
                type="submit"
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                ...
                Wash With Mild Detergent In Cold Water.Purple cotton shirt with
                casual collar and chest pocket.Hand Wash With Mild Detergent In
                Cold Water
              </p>
              <button
                type="submit"
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                Black and olive gabardine pant. Features button closure and zip
                fly.Hand Wash With Mild Detergent In Cold Water.Black and olive
                gabardine pant. Features button closure and zip fly.Hand Wash
                With Mild Detergent In Cold Water.
              </p>
              <button
                type="submit"
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                Pink denim jacket with printed cotton patch detail. Full button
                opening.Hand Wash With Mild Detergent In Cold WaterHand Wash
                With Mild Detergent In Cold Water.Hand Wash With Mild Detergent
                In Cold Water
              </p>
              <button
                type="submit"
