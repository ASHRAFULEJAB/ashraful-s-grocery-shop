...
import { BsArrowRightCircleFill, BsChevronDown, BsClipboard, BsFillArrowLeftCircleFill } from "react-icons/bs";
import { Link, Outlet } from "react-router-dom";
import logo from '../assets/add-to-cart.png'
import Header from "../shared/Header";

const LeftNavDashboard = () => {
  ...
  const subMenu = [
    ...
    { value: "option2", label: "Users Sub Menu-3", path: "/dashboard/AllUser" },
  ];
  return (
    <div>
      <aside
        class="flex flex-col w-64 h-screen px-8 py-8 overflow-y-auto 
      bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700"
      >
        <nav
          className={` absolute duration-500 ease-in-out space-y-8 text-lg text-gray-500 ${
            hideMenu ? "-left-52" : "left-0"
          }`}
        >
            ...
            <div className="flex justify-between items-center mb-5">
              <div>
                ...
                <Link to="/dashboard" className="flex">
                  ...
                  <span className= {`text-sm tracking-widest text-gray-100 uppercase font-bold ${
                    hideMenu && "text-white"
                  }`}>Admin Paneel</span>
                </Link>
              </div>
              ...
              <div>
                ...
                >
                  {hideMenu ? (
                    <BsArrowRightCircleFill className="h-10 w-10"></BsArrowRightCircleFill>
                  ) : (
          ...
          <div class="relative mt-6">
            ...
            <input
              type="text"
              class="w-full py-2 pl-10  text-gray-700 bg-white border rounded-md
          ...
          <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
              ...
              >
                ...
                <div className="relative inline-block text-left">
                  <div>
                    ...
                    >
                      <span className="flex items-center ">All Users</span>
                      <BsChevronDown className="ml-5 cursor-pointer"></BsChevronDown>
                    </div>
                  </div>
                  {isOpen && (
                    <div
                      className="origin-top-right absolute right-0 left-3 mt-2 w-52 rounded-md
                   shadow-lg bg-gray-800 text-white z-10 
              ...
              <Link
                class="flex items-center px-4 py-2 mt-5 text-gray-600 
              ...
              >
                ...
                <span class="mx-4 font-medium">Add New User</span>
              </Link>
              ...
              >
                ...
                <span class="mx-4 font-medium">Add New Product</span>
              </Link>
